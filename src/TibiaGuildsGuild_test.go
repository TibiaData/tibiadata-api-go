...
func TestElysium(t *testing.T) {
	...
	elysiumJson, _ := TibiaGuildsGuildImpl("Elysium", string(data))
	assert := assert.New(t)
...
func TestMercenarys(t *testing.T) {
	...
	mercenarysJson, _ := TibiaGuildsGuildImpl("Mercenarys", string(data))
	assert := assert.New(t)
...
func TestKotkiAntica(t *testing.T) {
	...
	kotkianticaJson, _ := TibiaGuildsGuildImpl("Kotki Antica", string(data))
	assert := assert.New(t)
