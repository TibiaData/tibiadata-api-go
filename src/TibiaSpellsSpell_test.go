...
func TestAnnihilation(t *testing.T) {
	...
	annihilationJson, _ := TibiaSpellsSpellImpl("Annihilation", string(data))
	assert := assert.New(t)
...
func TestBruiseBane(t *testing.T) {
	...
	bruisebaneJson, _ := TibiaSpellsSpellImpl("Bruise Bane", string(data))
	assert := assert.New(t)
...
func TestCurePoisonRune(t *testing.T) {
	...
	curepoisonruneJson, _ := TibiaSpellsSpellImpl("Cure Poison Rune", string(data))
	assert := assert.New(t)
...
func TestConvinceCreatureRune(t *testing.T) {
	...
	convincecreatureruneJson, _ := TibiaSpellsSpellImpl("Convince Creature Rune", string(data))
	assert := assert.New(t)
